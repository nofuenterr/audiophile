...
export default function Checkout() {
	return (
		<div>
			<GoBackButton />
			<MainWrapper>
				<ContentWrapper className="grid w-full content-start gap-8 lg:grid-cols-[1fr_21.875rem]">
...
function CheckoutForm() {
	return (
		<form action="" className="grid content-start gap-8 md:gap-10">
			...
			<div className="grid content-start gap-8 md:gap-13">
				...
				<InputGroup title="Payment Details" className="md:grid-cols-2">
					...
					>
						<RadioBlock name="paymentMethod" id="eMoney" label="e-Money" />
						<RadioBlock
							name="paymentMethod"
							id="cashOnDelivery"
					...
					/>
					<InputBlock id="eMoneyPin" label="e-Money PIN" placeholder="6891" />
				</InputGroup>
	...
	return (
		<div className={clsx('grid content-start gap-2', className)}>
			...
			<input
				...
				className="input w-full rounded-lg border px-6 py-5"
				border-input-border
...
function RadioBlock({ name, id, label }: RadioBlockProps) {
	return (
